...
function uploadWheels(venv_dir, hostname, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield venvExec(venv_dir, "twine", ["upload"], {
            env: {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield uploadWheels(venv_dir, pypi_hostname, pypi_username, pypi_password);
        }
        catch (error) {
